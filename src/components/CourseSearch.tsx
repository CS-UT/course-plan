      ...
      {slotFilter && (
        <div className="flex items-center justify-between gap-2 px-2.5 py-1.5 bg-primary-50 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800 rounded-lg text-xs text-primary-700 dark:text-primary-300">
          ...
          <button
            ...
            className="text-gray-500 dark:text-gray-400 hover:text-danger-600 dark:hover:text-danger-400 active:text-danger-700 cursor-pointer p-1.5 -m-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
