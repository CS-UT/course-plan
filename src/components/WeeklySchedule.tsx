...
export function WeeklySchedule({ hoveredCourse, onEditCourse }: Props) {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/50 rounded-2xl shadow-lg shadow-purple-500/5 border border-purple-200/30 dark:border-purple-500/15 p-3 relative transition-colors">
      ...
      {tooltip.visible && tooltip.content && (
        <div
          ref={tooltipRef}
          className="fixed z-50 bg-white/95 dark:bg-gray-900/95 rounded-2xl shadow-xl shadow-purple-500/10 border border-purple-200/30 dark:border-purple-500/15 p-3 text-sm w-64"
        ...
        >
          ...
          <div className="mt-2 flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 text-xs font-medium text-purple-600 dark:text-purple-400 bg-purple-50/50 dark:bg-purple-900/20 hover:bg-purple-100/50 dark:hover:bg-purple-900/30 rounded-xl transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 px-2 py-1.5 text-xs font-medium text-pink-600 dark:text-pink-400 bg-pink-50/50 dark:bg-pink-900/20 hover:bg-pink-100/50 dark:hover:bg-pink-900/30 rounded-xl transition-colors cursor-pointer"
            >
      ...
      {/* Mobile action sheet */}
      {tappedCourse && (
        <div className="fixed inset-0 z-50 bg-purple-900/20 backdrop-blur-sm" onClick={() => setTappedCourse(null)}>
          <div
            className="absolute bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-900/95 rounded-t-3xl p-5 pb-8 shadow-2xl shadow-purple-500/10 border-t border-purple-200/30 dark:border-purple-500/15"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Drag handle */}
            <div className="w-10 h-1 bg-gradient-to-r from-violet-300 to-pink-300 dark:from-violet-500 dark:to-pink-500 rounded-full mx-auto mb-4" />
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-purple-700 dark:text-purple-300 bg-purple-50/50 dark:bg-purple-900/20 hover:bg-purple-100/50 dark:hover:bg-purple-900/30 rounded-xl transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-pink-600 dark:text-pink-400 bg-pink-50/50 dark:bg-pink-900/20 hover:bg-pink-100/50 dark:hover:bg-pink-900/30 rounded-xl transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full px-4 py-3 text-sm font-medium text-purple-400 dark:text-purple-400 hover:bg-purple-50/50 dark:hover:bg-purple-900/10 rounded-xl transition-colors cursor-pointer"
              >
                انصراف
              </button>
            </div>
