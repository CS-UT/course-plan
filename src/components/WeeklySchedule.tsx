    ...
    <div data-tour="calendar" className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 relative transition-colors">
      ...
      <div className="flex justify-start mb-2">
        <button
          ...
          data-export-exclude
          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600 transition-colors cursor-pointer"
      ...
      {!slotHintDismissed && !slotFilter && !rotated && (
        <div className="hidden lg:flex items-center gap-2 mb-2 px-1 text-xs text-gray-400 dark:text-gray-500" data-export-exclude>
          ...
          <button
            ...
            className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 cursor-pointer p-1.5 -m-1 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
            title="بستن"
          >
        ...
        >
          ...
          <div className="mt-2 flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/30 hover:bg-primary-100 dark:hover:bg-primary-900/50 active:bg-primary-200 dark:active:bg-primary-900/70 rounded-lg transition-colors cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-danger-600 dark:text-danger-400 bg-danger-50 dark:bg-danger-500/10 hover:bg-danger-100 dark:hover:bg-danger-500/20 active:bg-danger-200 dark:active:bg-danger-500/30 rounded-lg transition-colors cursor-pointer"
            >
                    ...
                    {!evt.isHover && !isTouchDevice && (
                      <div className="absolute inset-0 bg-black/0 group-hover/evt:bg-black/40 transition-colors rounded flex items-center justify-center gap-1.5 opacity-0 pointer-events-none group-hover/evt:opacity-100 group-hover/evt:pointer-events-auto">
                        <button
                          ...
                          className="p-1.5 bg-white/90 dark:bg-gray-800/90 rounded-md hover:bg-white dark:hover:bg-gray-700 active:bg-gray-100 dark:active:bg-gray-600 transition-colors cursor-pointer"
                          title="ویرایش"
                        >
