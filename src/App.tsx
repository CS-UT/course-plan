...
function MobileBanner() {
  ...
  return (
    <div className="lg:hidden bg-gradient-to-r from-violet-50 to-pink-50 dark:from-violet-900/20 dark:to-pink-900/20 border-b border-purple-200/50 dark:border-purple-500/20 px-4 py-2.5 flex items-center justify-between gap-3">
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-100 via-sky-100 to-rose-100 dark:from-gray-950 dark:via-indigo-950 dark:to-purple-950 text-gray-900 dark:text-gray-100 transition-colors">
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-purple-200/50 dark:border-purple-500/20 sticky top-0 z-40 transition-colors shadow-sm shadow-purple-500/5">
        <div className="max-w-[1600px] mx-auto px-4 py-2.5 flex items-center justify-between gap-2">
          <span className="text-sm text-purple-600 dark:text-purple-300 hidden sm:inline truncate">
            {data.semesterLabel} — {data.department}
          </span>
          <div className="flex items-center gap-2 sm:gap-3 mr-auto sm:mr-0">
            <span className="text-sm font-medium bg-gradient-to-r from-violet-500/10 to-pink-500/10 dark:from-violet-400/15 dark:to-pink-400/15 text-purple-700 dark:text-purple-300 px-3 py-1 rounded-full whitespace-nowrap border border-purple-200/50 dark:border-purple-400/20">
            ...
            <a
              ...
              className="p-2 rounded-xl hover:bg-purple-100/50 dark:hover:bg-purple-500/10 transition-colors text-purple-600 dark:text-purple-300"
              title="GitHub"
            >
            ...
            <button
              onClick={toggleDark}
              className="p-2 rounded-xl hover:bg-purple-100/50 dark:hover:bg-purple-500/10 transition-colors cursor-pointer text-purple-600 dark:text-purple-300"
  ...
  return (
    <div className="lg:hidden">
      <button
        ...
        className="fixed bottom-5 right-4 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-pink-500 text-white px-5 py-3.5 rounded-full shadow-lg shadow-purple-500/25 z-50 font-medium cursor-pointer text-sm"
      >
        + افزودن درس
      </button>
      {open && (
        <div className="fixed inset-0 z-50 bg-black/30" onClick={() => setOpen(false)}>
          <div
            className="absolute bottom-0 left-0 right-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-t-3xl max-h-[85vh] overflow-y-auto pb-6 border-t border-purple-200/50 dark:border-purple-500/20"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Drag handle */}
            <div className="sticky top-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl pt-3 pb-2 px-4 z-10 rounded-t-3xl">
              <div className="w-10 h-1 bg-gradient-to-r from-violet-300 to-pink-300 dark:from-violet-500 dark:to-pink-500 rounded-full mx-auto mb-3" />
              <div className="flex justify-between items-center">
                <h3 className="font-bold text-lg">انتخاب درس</h3>
                <button onClick={() => setOpen(false)} className="text-purple-400 dark:text-purple-400 p-1.5 -m-1.5 rounded-xl hover:bg-purple-100/50 dark:hover:bg-purple-500/10 cursor-pointer">
